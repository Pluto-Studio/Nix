...
import club.plutoproject.nix.contentsystem.registry.DataComponentTypeRegistryEntry;
...
@ApiStatus.Internal
public final class CustomDataComponentRegistryEntry {

    private CustomDataComponentRegistryEntry() {
    }
    ...
    public static final class PaperBuilder implements
        ...
        public DataComponentType<?> build() {
            ...
            final ResourceKey<DataComponentType<?>> key = (ResourceKey<DataComponentType<?>>) RegistrationKeyScope.requireCurrent();
