 ...
 */
public final class ContentSystemItem extends Item {
    ...
    public static boolean isCustom(final Item item) {
        return item instanceof ContentSystemItem;
    }

    public static Material vanillaMaterial(final Item item) {
        return item instanceof ContentSystemItem custom ? custom.vanillaMaterial() : CraftMagicNumbers.getMaterial(item);
    }
    ...
    public InteractionResult use(final Level level, final net.minecraft.world.entity.player.Player player, final InteractionHand hand) {
        ...
        final ContentSystemDefaultCall<ItemUseResult> defaults = new ContentSystemDefaultCall<>(() -> {
            final InteractionResult result = super.use(level, player, hand);
            return new ContentSystemDefaultCall.DefaultValue<>(ContentSystemResultConversion.fromVanillaUse(result), result);
        });
        ...
        final ItemUseResult result = ContentSystemHookDispatcher.dispatch(
            this,
            ItemHooks.ON_USE,
            context,
            defaults,
        ...
        return ContentSystemResultConversion.toNmsInteraction(result, defaults);
    }
    ...
    public InteractionResult useOn(final UseOnContext context) {
        ...
        final ContentSystemDefaultCall<ItemInteractionResult> defaults = new ContentSystemDefaultCall<>(() -> {
            final InteractionResult result = super.useOn(context);
            return new ContentSystemDefaultCall.DefaultValue<>(ContentSystemResultConversion.fromVanillaInteraction(result), result);
        });
        ...
        final ItemInteractionResult result = ContentSystemHookDispatcher.dispatch(
            this,
    ...
    public void onUseTick(final Level level, final LivingEntity livingEntity, final ItemStack itemStack, final int ticksRemaining) {
        final ContentSystemDefaultCall<Void> defaults = new ContentSystemDefaultCall<>(() -> {
            super.onUseTick(level, livingEntity, itemStack, ticksRemaining);
            return new ContentSystemDefaultCall.DefaultValue<>(null, null);
        });
        ...
        ContentSystemHookDispatcher.dispatch(
            this,
    ...
    public ItemStack finishUsingItem(final ItemStack itemStack, final Level level, final LivingEntity entity) {
        ...
        final ContentSystemDefaultCall<org.bukkit.inventory.ItemStack> defaults = new ContentSystemDefaultCall<>(() -> {
            final ItemStack result = super.finishUsingItem(itemStack, level, entity);
            return new ContentSystemDefaultCall.DefaultValue<>(CraftItemStack.asCraftMirror(result), result);
        });
        ...
        final org.bukkit.inventory.ItemStack result = ContentSystemHookDispatcher.dispatch(
            this,
    ...
    public boolean releaseUsing(final ItemStack itemStack, final Level level, final LivingEntity entity, final int remainingTime) {
        ...
        final ContentSystemDefaultCall<ItemReleaseUseResult> defaults = new ContentSystemDefaultCall<>(() -> {
            final boolean result = super.releaseUsing(itemStack, level, entity, remainingTime);
            return new ContentSystemDefaultCall.DefaultValue<>(
                result
        ...
        final ItemReleaseUseResult result = ContentSystemHookDispatcher.dispatch(
            this,
    ...
    public boolean canDestroyBlock(final ItemStack itemStack, final BlockState state, final Level level, final BlockPos pos, final LivingEntity user) {
        final ContentSystemDefaultCall<Boolean> defaults = new ContentSystemDefaultCall<>(() -> {
            final boolean result = super.canDestroyBlock(itemStack, state, level, pos, user);
            return new ContentSystemDefaultCall.DefaultValue<>(result, result);
        });
        ...
        return ContentSystemHookDispatcher.dispatch(
            this,
    ...
    public float getDestroySpeed(final ItemStack itemStack, final BlockState state) {
        final ContentSystemDefaultCall<Float> defaults = new ContentSystemDefaultCall<>(() -> {
    ...
    public boolean mineBlock(final ItemStack itemStack, final Level level, final BlockState state, final BlockPos pos, final LivingEntity owner) {
        final ContentSystemDefaultCall<ItemMineBlockResult> defaults = new ContentSystemDefaultCall<>(() -> {
        ...
        final ItemMineBlockResult result = ContentSystemHookDispatcher.dispatch(
            this,
